...
class StackOverflowQuestion
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'score' => $this->getScore(),
            'last_activity_date' => $this->getLastActivityDate() ? $this->getLastActivityDate()->getTimestamp() : null,
            'creation_date' => $this->getCreationDate() ? $this->getCreationDate()->getTimestamp() : null,
            'last_edit_date' => $this->getLastEditDate() ? $this->getLastEditDate()->getTimestamp() : null,
